...
public class SubmissionServiceIntegrationTest {
    ...
    void testSubmitCodeIntegration() {
        ...
        Assertions.assertEquals(1L, savedSubmission.getUserId(), "User ID should match");
        Assertions.assertEquals(1L, savedSubmission.getProblemId(), "Problem ID should match");
